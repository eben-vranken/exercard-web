  ...
  return (
    <main className="w-full min-h-screen flex flex-col gap-y-10">
      ...
      <article className="flex flex-col items-end gap-y-4 text-justify">
        <section>
          <header className="text-right">
            <h1 className="text-main">The Forgetting Curve</h1>
          </header>
          <p>
        ...
        <figure className="w-3/4 flex flex-col text-right">
          ...
          <span className="text-xs">The image above indicates how fast information fades from our memory without reinforcement. </span>
      ...
      <article className="flex flex-col text-justify gap-y-4">
        <section>
          <header>
            <h1 className="text-main">How Spaced Repetition Works</h1>
          </header>
          <p>
